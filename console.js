...
console.log("%c(obj1 ... objN:object || (msg:string, subst1...substN:object))", "color: white; font-size: 15px; background-color: LightSeaGreen;padding: 5px");
console.log("");
...
console.log("%cinfo", "color: white; font-size: 15px; background-color: cornflowerblue;padding: 5px");
console.log("%c(obj1 ... objN:object || (msg:string, subst1...substN:object))", "color: white; font-size: 15px; background-color: LightSeaGreen;padding: 5px");
console.log("");
...
console.log("%cwarn", "color: white; font-size: 15px; background-color: cornflowerblue;padding: 5px");
console.log("%c(obj1 ... objN:object || (msg:string, subst1...substN:object))", "color: white; font-size: 15px; background-color: LightSeaGreen;padding: 5px");
console.log("");
...
console.log("%cerror, exception (deprecated)", "color: white; font-size: 15px; background-color: cornflowerblue;padding: 5px;");
console.log("%c(obj1 ... objN:object || (msg:string, subst1...substN:object))", "color: white; font-size: 15px; background-color: LightSeaGreen;padding: 5px");
console.log("");
...
console.log("%c(object:object)", "color: white; font-size: 15px; background-color: LightSeaGreen;padding: 5px");
console.log("");
...
console.log("%c(assertion:bool, obj1 ... objN:object || (msg:string, subst1...substN:object))", "color: white; font-size: 15px; background-color: LightSeaGreen;padding: 5px");
console.log("");
...
console.log("%c()", "color: white; font-size: 15px; background-color: LightSeaGreen;padding: 5px");
console.log("");
...
console.log("%ccount, countReset", "color: white; font-size: 15px; background-color: cornflowerblue;padding: 5px");
console.log("%c(label(optional):string)", "color: white; font-size: 15px; background-color: LightSeaGreen;padding: 5px");
console.log("");
...
console.log("%cgroup, groupCollapsed, groupEnd", "color: white; font-size: 15px; background-color: cornflowerblue;padding: 5px");
console.log("%c(label(optional):string)", "color: white; font-size: 15px; background-color: LightSeaGreen;padding: 5px");
console.log("");
...
console.log("%ctime, timeLog, timeEnd", "color: white; font-size: 15px; background-color: cornflowerblue;padding: 5px");
console.log("%c(label(optional):string)", "color: white; font-size: 15px; background-color: LightSeaGreen;padding: 5px");
console.log("");
...
console.log("%cNot standardized", "color: white; font-size: 15px; background-color: crimson;padding: 5px");
console.log("%cprofile, profileEnd", "color: white; font-size: 15px; background-color: cornflowerblue;padding: 5px");
console.log("%c(label(optional):string)", "color: white; font-size: 15px; background-color: LightSeaGreen;padding: 5px");
console.log("");
